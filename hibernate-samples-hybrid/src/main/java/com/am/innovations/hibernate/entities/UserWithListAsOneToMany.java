...
//@Entity
public class UserWithListAsOneToMany implements Serializable {
	...
	public UserWithListAsOneToMany() {
		super();
	}

	public UserWithListAsOneToMany(Long userID, String userName) {
		super();
		this.userID = userID;
		this.userName = userName;
	}

	public UserWithListAsOneToMany(String userName) {
		super();
		this.userName = userName;
	}
